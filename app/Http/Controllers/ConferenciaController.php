...
class ConferenciaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        $baldes = [
            ...
            VinculadorService::REPETIDO_NO_SISTEMA => collect(),
        ];
        ...
        if ($sistema) {
            ...
            foreach ($pendentes as $registro) {
                ...
                if ($motivo !== null) {
                    $baldes[$motivo]->push([
                        'registro' => $registro,
                        'candidatos' => in_array($motivo, [VinculadorService::VARIOS_CANDIDATOS, VinculadorService::REPETIDO_NO_SISTEMA], true)
