...
| ASM-033 | A chave de integração é gerada pela matriz e o sistema guarda apenas o resumo criptográfico dela, nunca a chave em claro | confirmada | Implementado no AlfaGym em 07/08/2026: `matriz.api-key-hash` guarda o SHA-256 e o filtro compara por `MessageDigest.isEqual`; a chave em claro nunca é gravada |
