...
## T-062 — Retrato local: licenças, usuários e contadores [concluida]
- Refs: US-036, AC-084, AC-085, AC-086, AC-088, AC-089
- Arquivos: database/migrations/2026_08_07_120400_create_sistema_licencas_table.php, database/migrations/2026_08_07_120500_create_sistema_usuarios_table.php, database/migrations/2026_08_07_120700_create_sistema_contadores_table.php, app/Models/SistemaLicenca.php, app/Models/SistemaUsuario.php, app/Models/SistemaContador.php, tests/Feature/Integracao/RetratoLocalTest.php
...
- Arquivos: app/Services/Integracao/ConectorSistema.php, app/Services/Integracao/RespostaIntegracao.php, app/Services/Integracao/ErroIntegracao.php, app/Services/Integracao/Documento.php, app/Services/Integracao/Dto/ClienteExterno.php, app/Services/Integracao/Dto/RevendaExterna.php, app/Services/Integracao/Dto/LicencaExterna.php, app/Services/Integracao/Dto/PlanoExterno.php, app/Services/Integracao/Dto/UsuarioExterno.php, app/Services/Integracao/Dto/ContadoresExternos.php, tests/Feature/Integracao/ContratoEmCodigoTest.php
...
## T-068 — Sincronizar o cadastro do sistema [concluida]
- Refs: AC-084, AC-085
...
## T-069 — Ausência na origem e varredura interrompida [concluida]
- Refs: AC-086, AC-087
...
## T-070 — Sincronizar licenças e contadores [concluida]
- Refs: AC-084, AC-088, AC-089
- Arquivos: app/Services/Integracao/SincronizacaoService.php, tests/Feature/Integracao/SincronizacaoLicencasContadoresTest.php
- Notas: **nenhum valor financeiro vem dos sistemas** (ASM-031). Só entram licenças — com plano,
  início, fim e se bloqueia o acesso — e a contagem da unidade de cobrança por competência, que é
  o que alimenta a tela de contratos e uso e as divergências. Contadores são únicos por
  `(sistema, competência)`.

## T-071 — Comando e agendamento da sincronização [concluida]
- Refs: AC-084
...
## T-072 — Importar o cadastro que já existe no sistema [concluida]
...
- Arquivos: resources/views/components/atualizado-em.blade.php, resources/views/integracao/index.blade.php, app/Http/Controllers/IntegracaoController.php, app/Console/Commands/RetratoDeDemonstracao.php, resources/views/layouts/navigation.blade.php, routes/web.php, tests/Feature/Integracao/TelasTest.php
...
- Notas: **nenhum valor vem dos sistemas.** O que o cliente paga sai de
  `clientes.valor_mensal` (matriz) e o uso sai do retrato local (sistema). A tela cruza os dois e
  destaca quem está ativo lá dentro sem valor cadastrado aqui — uso que ninguém está cobrando.
...
## T-080 — AlfaGym: chave da matriz e endereços de leitura [concluida]
- Refs: AC-096
...
## T-081 — Ligar de verdade e provar o formato [concluida]
- Refs: AC-097
