...
## T-046 — Cadastro do AlfaMatriz no inventário do painel [concluida]
- Refs: US-028, AC-063, AC-064
...
## T-047 — Executor do staging com portão de testes [concluida]
- Refs: US-029, AC-065, AC-066
...
## T-048 — Vigia de tag para produção [concluida]
- Refs: US-030, AC-067, AC-068
...
## T-049 — Provisionar o container de staging [concluida]
- Refs: US-029, AC-065
...
## T-050 — Verificação automática no GitHub [concluida]
- Refs: US-029, AC-066
...
- Notas: roda a suíte a cada push e em cada tag. Não é o portão do staging (esse
  é local, T-047), mas dá o mesmo sinal verde/vermelho que os outros sistemas
  têm no GitHub antes de alguém marcar versão.

## T-051 — Cópia embaralhada da produção para o staging [concluida]
- Refs: US-031, AC-069
...
## T-052 — Instalar e conferir no servidor [concluida]
- Refs: US-028, US-029, US-030, AC-063, AC-065, AC-067
- Arquivos: README.md
