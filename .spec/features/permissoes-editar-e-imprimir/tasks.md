...
## T-001 — A ação `imprimir` passa a recusar [concluida]
...
## T-002 — A coluna `editar` e o backfill [concluida]
...
## T-003 — `editar` vira ação de verdade no domínio [concluida]
...
## T-004 — As edições que usam POST [concluida]
- Refs: US-078, AC-278
