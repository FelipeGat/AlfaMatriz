...
## T-019 — Fábricas dos modelos do contas a pagar [pendente]
...
## T-020 — Provar a geração das parcelas do mês [pendente]
...
## T-021 — Provar idempotência e data de vencimento [pendente]
