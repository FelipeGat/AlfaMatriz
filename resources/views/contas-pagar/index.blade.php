                    ...
                    <tbody>
                        @forelse ($contasPagar as $contaPagar)
                            ...
                            <tr class="border-b border-line transition-colors last:border-0 hover:bg-raised">
                                <td class="px-5 py-3 text-[13px] text-ink">{{ $contaPagar->descricao }}</td>
                        ...
                        @empty
                            <tr><td colspan="6" class="px-5 py-[34px] text-center text-[13px] text-mute">Nenhuma despesa encontrada.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
