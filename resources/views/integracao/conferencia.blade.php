        ...
        @else
            ...
            @php
                $rotulos = [
                    ...
                    'repetido_no_sistema' => ['Repetido no próprio sistema', 'O mesmo documento aparece mais de uma vez aqui dentro. Ligar os dois ao mesmo cliente da matriz faturaria a mesma academia duas vezes — escolha qual fica.'],
                ];
                        ...
                        <div class="mt-3 space-y-2">
                            @foreach ($linhas as $linha)
                                ...
                                <div class="flex flex-wrap items-center gap-3 rounded-tile border border-line bg-input px-3 py-2">
                                    ...
                                    @if (in_array($motivo, ['varios_candidatos', 'repetido_no_sistema'], true))
