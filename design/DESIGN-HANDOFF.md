...
> **Este arquivo NÃO substitui o `CLAUDE.md` do repositório.** Ele fica na pasta do handoff (ex.:
> `design/DESIGN-HANDOFF.md`). Para o agente achá-lo, acrescente UMA linha ao `CLAUDE.md` que já existe na
> raiz:
>
> ```
> Redesign visual em andamento: leia design/DESIGN-HANDOFF.md antes de mexer em views ou no fluxo de tarefas.
> ```
>
> Onde este texto disser `README.md` ou `TAREFAS-SPEC.md`, leia `design/README.md` e
> `design/TAREFAS-SPEC.md`.
>
> Estado do repositório conferido em 12/08/2026. Parte do plano abaixo já foi implementada entre o desenho e
> a entrega — confira antes de criar.
